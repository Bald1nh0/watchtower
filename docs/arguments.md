...
## Docker API version
The API version to use by the Docker client for connecting to the Docker daemon. Leave it unset to let the client negotiate the version with the daemon automatically.
...
the [pre-check/post-check hooks](https://bald1nh0.github.io/watchtower/lifecycle-hooks/), but will __not__ update the
containers.
...
For details see [HTTP API](https://bald1nh0.github.io/watchtower/http-api-mode).
...
This enables [running multiple instances](https://bald1nh0.github.io/watchtower/running-multiple-instances).
